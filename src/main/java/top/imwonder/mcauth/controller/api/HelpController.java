...
public class HelpController {
    ...
    @GetMapping("/update")
    public DownloadBean getFileUrl(String FileName) throws UnsupportedEncodingException {
        ...
        // 返回登录信息的转码
        downloadBean.setAuth("Basic " + Base64.getEncoder().encodeToString("jhu:430525@HJf".getBytes("utf-8")));
        return downloadBean;
    }
